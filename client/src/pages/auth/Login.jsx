  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (normalizedRole === 'student') {
        ...
        console.log('Navigating to: /dashboard/member');
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Sport <span style={{ color: '#0891b2' }}>Faction</span>
            </div>
            <div
              style={{
                fontSize: 11,
        ...
        <div style={{ zIndex: 1 }}>
          ...
          >
            {role === 'student' ? 'Student Portal' : 'Member Portal'}
          </div>
          ...
          >
            Your Gateway
            <br />
            to <span style={{ color: '#0891b2' }}>Elite</span>
            <br />
            Sports Training
          </h1>
          ...
          >
            Access your training schedule, track progress, manage bookings, and stay updated
            with events — all in one place.
          </p>
        ...
        <div style={{ fontSize: 12, color: '#0f172a', zIndex: 1 }}>
          © 2026 Sport Faction Academy · All rights reserved
        </div>
      </div>
      ...
      >
        <div style={{ width: '100%', maxWidth: 440 }}>
          <div style={{ marginBottom: 36 }}>
            <h2 style={{ fontSize: 28, fontWeight: 700, color: '#1a202c', marginBottom: 6 }}>
            ...
            {roles.map(({ id, label, Icon }) => (
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor: 'pointer',
                  background: role === id ? '#fff' : 'transparent',
                  color: role === id ? '#1a202c' : '#718096',
                  fontWeight: role === id ? 600 : 400,
                  fontSize: 13,
                  boxShadow: role === id ? '0 1px 4px rgba(0,0,0,0.12)' : 'none',
                  transition: 'all 0.2s',
                }}
              >
          ...
          >
            <p style={{ fontSize: 12, color: '#718096', margin: 0 }}>
              <strong style={{ color: '#4a5568' }}>Admin?</strong> Use the dedicated{' '}
              <a
                href="/admin/"
